...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      const response = await fetchClientSide<Response>("POST", "/auth/login", {
        email,
        password,
      })
      router.push("/")
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-950">
      <div className="flex flex-col items-center justify-center text-gray-100 bg-gray-900 border border-gray-800 p-8 rounded-2xl">
        <Image src={LogoImage || "/placeholder.svg"} width={150} height={150} alt="Logo" className="mb-6" />
        <h1 className="text-gray-300 text-2xl">Fleet Manager</h1>
        <h3 className="text-gray-500 text-xs mb-4">Sistema de Gerenciamento de Frota</h3>
