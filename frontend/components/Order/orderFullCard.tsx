import { Building, Calendar, DollarSign, CheckCircle } from "lucide-react"
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 p-6 rounded-2xl">
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-sm font-medium text-gray-400 mb-1">Tipo de Serviço</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <h3 className="text-sm font-medium text-gray-400 mb-1">Data do Serviço</h3>
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <p className="text-lg font-semibold text-emerald-400">{formatCurrency(order.totalCost)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {order.endDate ? (
            <div>
              <h3 className="text-sm font-medium text-gray-400 mb-1">Concluído em</h3>
              <div className="flex items-center text-emerald-400">
                <CheckCircle className="h-4 w-4 mr-2" />
                <p>{formatDateTime(order.endDate)}</p>
              </div>
            </div>
          ) : (
            <div>
              <h3 className="text-sm font-medium text-gray-400 mb-1">Última atualização</h3>
