...
import { Order, User, Vehicle } from "@/types/types";
import {
  formatCurrency,
  formatDate,
  formatShortDate,
  ...
  const handleDeleteUser = async () => {
    ...
    if (confirmDelete) {
      try {
        ...
        // Adicionar lógica de mensagem de erro
      }
    } else {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="mt-4 space-y-4">
                      <div>
                        ...
                        <p className="font-medium text-lg text-emerald-400">
                          {formatCurrency(resume.totalCost)}
                        </p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium text-gray-400 mb-1">
                        ...
                        <p className="font-medium">
                          {formatCurrency(resume.averageCost)}
                        </p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium text-gray-400 mb-1">
                  ...
                  <div className="text-gray-100 bg-gray-900 border border-gray-800 p-8 rounded-2xl">
                    ...
                    <div className="mt-4 space-y-4">
                      <div>
                        <h3 className="text-sm font-medium text-gray-400 mb-1">
                          Total de Dias em Manutenção
                        </h3>
                        <p className="font-medium">
                          {resume.totalDays.toFixed(0)} dias
                        </p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium text-gray-400 mb-1">
                        ...
                        <div className="flex items-center">
                          ...
                          {resume.mostRecent.endDate && (
                            <p className="text-xs">
                              ({resume.daysSinceLast} dias atrás)
                            </p>
                          )}
                        </div>
                      </div>
